...
<?php
  ...
  include_once 'new-account.php'; //submitting form to self
    ...
    if(isset($_POST['submit'])){ 
        ...
        // sends email notification to the site admin 
           ...
           $htmlContent = " 
            ...
            $status = 'success'; 
            $statusMsg = '<p style="color:#00008B ;"><br>Thank you! Your new account request has submitted successfully, we will get back to you soon. </p>'; 
            $postData = ''; 
              }else{ 
